...
public static class AlexShortcuts
{
    ...
    */
    ...
    public static bool ValidateFindSourceAsset()
    {
        ...
        if (PrefabUtility.GetCorrespondingObjectFromOriginalSource(gameObject) != null) return true;
    ...
    public static void FindSourceAsset()
    {
        ...
        var parent = PrefabUtility.GetCorrespondingObjectFromOriginalSource(gameObject);
        if (parent != null)
        {
